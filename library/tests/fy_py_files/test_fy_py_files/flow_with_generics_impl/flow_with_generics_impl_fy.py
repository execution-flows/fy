...
"""fy
from .greetings_t import GreetingT, FrenchGreeting, GreetT


flow HelloWorld[GreetingT] -> None:
    property greeting using greeting_message[FrenchGreeting]
    method greet using greeting_message[GreetT]
"""
...
from fy_py_files.test_fy_py_files.flow_with_generics_impl.method.method_fy import (
    Greet_UsingGreetingMessage_MethodMixin,
)
from .greetings_t import GreetingT, FrenchGreeting, GreetT
...
class HelloWorld_Flow(
    ...
    # Method Mixins
    Greet_UsingGreetingMessage_MethodMixin[GreetT],
    # Base
    FlowBase[None],
    Generic[GreetingT],
):
