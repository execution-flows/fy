...
flow GenerateAndSaveFyPyFiles_UsingRequiredPropertySetters -> None:
    ...
    property base_flow_required_property_setters_fy_py using setter
"""
...
from fy_library.mixins.property.base_flow_required_property_setters_fy_py.using_setter import (
    BaseFlowRequiredPropertySettersFyPy_UsingSetter_PropertyMixin,
)
...
class GenerateAndSaveFyPyFiles_UsingRequiredPropertySetters_Flow(
    ...
    def __init__(
        ...
        *args: Any,
        ...
        base_flow_required_property_setters_fy_py: List[ParsedFyPyFile],
        **kwargs: Any,
    ):
        self._required_property_setters_fy_py = required_property_setters_fy_py
        self._base_flow_required_property_setters_fy_py = base_flow_required_property_setters_fy_py
        super().__init__(*args, **kwargs)

    def __call__(self) -> None:
        # fy:end <<<===
        if self._required_property_setters_fy_py is not None:
            for parsed_fy_py_file in self._required_property_setters_fy_py:
                GenerateAndSaveFyPyFile_UsingRequiredPropertySetters_Flow(
                    parsed_fy_py_file=parsed_fy_py_file,
                )()
        if self._base_flow_required_property_setters_fy_py is not None:
            for parsed_fy_py_file in self._base_flow_required_property_setters_fy_py:
                GenerateAndSaveFyPyFile_UsingRequiredPropertySetters_Flow(
                    parsed_fy_py_file=parsed_fy_py_file,
                )()
