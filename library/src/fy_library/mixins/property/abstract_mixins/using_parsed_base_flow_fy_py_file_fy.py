...
property abstract_mixins: List[BaseMixinModel] using parsed_base_flow_fy_py_file:
...
class AbstractMixins_UsingParsedBaseFlowFyPyFile_PropertyMixin(
    ...
    def _abstract_mixins(self) -> List[BaseMixinModel]:
        ...
        return cast(
            List[BaseMixinModel],
            parsed_base_flow_fy_py_file.abstract_property_mixins
            + parsed_base_flow_fy_py_file.abstract_method_mixins,
        )
