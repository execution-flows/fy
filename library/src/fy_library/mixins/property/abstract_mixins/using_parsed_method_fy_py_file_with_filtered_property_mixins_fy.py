...
property abstract_mixins: List[BaseMixinModel] using parsed_method_fy_py_file_with_filtered_property_mixins:
...
# fy:start ===>>>
class AbstractMixins_UsingParsedMethodFyPyFileWithFilteredPropertyMixins_PropertyMixin(
    # Property_mixins
    ParsedFyPyFile_PropertyMixin_ABC,
    abc.ABC,
):
    ...
    def _abstract_mixins(self) -> List[BaseMixinModel]:
        ...
        return cast(
            List[BaseMixinModel], parsed_method_fy_py_file.abstract_property_mixins
        )
