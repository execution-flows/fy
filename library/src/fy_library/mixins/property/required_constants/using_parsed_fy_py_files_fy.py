...
"""fy
property required_constants: dict[str, PropertySetterFyPyFile] using parsed_fy_py_files:
...
from fy_library.mixins.property.required_constants.abc_fy import (
    RequiredConstants_PropertyMixin_ABC,
)


# fy:start ===>>>
class RequiredConstants_UsingParsedFyPyFiles_PropertyMixin(
    # Property_mixins
    ParsedFyPyFiles_PropertyMixin_ABC,
    ParsedFyPyFilesMapByKey_PropertyMixin_ABC,
    RequiredConstants_PropertyMixin_ABC,
    ...
    @cached_property
    def _required_constants(self) -> dict[str, PropertySetterFyPyFile]:
        # fy:end <<<===
        def get_properties(
